...
return [
     ...
     */
    'inclusions' => ['MIX_PUSHER_APP_KEY', 'MIX_PUSHER_APP_CLUSTER', 'APP_PORT', 'APP_SERVICE', 'MEILISEARCH_NO_ANALYTICS', 'VITE_APP_NAME', 'VITE_PORT', 'VITE_PUSHER_APP_CLUSTER', 'VITE_PUSHER_APP_KEY', 'VITE_PUSHER_HOST', 'VITE_PUSHER_PORT', 'VITE_PUSHER_SCHEME'],
];
